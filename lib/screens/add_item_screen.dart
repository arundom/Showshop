...
/// Form screen for adding a new [Item].
///
/// Requires an active internet connection: items are written directly to
/// Supabase so they are immediately visible to all users.  If the device is
/// offline the user sees a dialog explaining that they must be online.
...
class _AddItemScreenState extends State<AddItemScreen> {
  ...
  Future<void> _save() async {
      ...
      if (mounted) {
        showDialog<void>(
          ...
          builder: (_) => AlertDialog(
            ...
            content: const Text(
              'Adding new items requires an internet connection.\n\n'
    ...
    // No local id — Supabase generates the UUID.
    final item = Item(
